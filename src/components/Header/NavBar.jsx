  ...
  return (
    <nav>
      <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
        <li>
          <Link to="/calculator" className="nav-link text-secondary text-center">
        ...
        <li>
          <Link to="/currencyconverter" className="nav-link text-secondary text-center">
              <i className="bi-currency-exchange h2 d-block" />
              Currency Converter
          </Link>
        </li>
        <li>
          <Link to="/unitconverter" className="nav-link text-secondary text-center">
              <i className="bi bi-arrow-left-right h2 d-block" />
              Unit Converter
          </Link>
        </li>
        <li>
          <Link to="/bmicalculator" className="nav-link text-secondary text-center">
        ...
        <li>
          <Link to="/worldClock" className="nav-link text-secondary text-center">
              <i className="bi bi-calendar-event-fill h2 d-block" />
              World Clock
          </Link>
        </li>
